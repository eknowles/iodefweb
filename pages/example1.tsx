...
const Page = () => {
  return (
    <>
      <Sender></Sender>
      <LineGrid preset={gridPresets[1]} color="black" opacity={0.1} />
      <LineGrid preset={gridPresets[1]} color="black" clamp opacity={0.5} />
      <Image
        path="ID_Imagery_Tonality&Colours_1.jpg"
